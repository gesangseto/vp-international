...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <div class="row">
                <div class="col-md-10">
                    <h1 class="h3 mb-0 text-gray-800">Pendaftaran Task</h1>
                </div>
                <div class="col-md-2">
                </div>
            </div>
        ...
        <div class="card-body">
            <form action=" <?= site_url('database/task/create') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
