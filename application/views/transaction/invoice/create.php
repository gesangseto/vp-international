                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>TO</label>
                                    <input id="agent_id" name="agent_id" readonly type="hidden" value="<?= @$form['agent_id'] ?>">
                                    <input id="agent_name" name="agent_name" class="form-control" required onclick="get_agent()" type="text" autocomplete="off" placeholder="Seach Agent">
                                </div>
                                <div class="col-md-12">
                                    <label>Address</label>
                                    <textarea class="form-control" readonly id="agent_address"></textarea>
                                </div>
                                <div class="col-md-12">
                                    <label>PHONE</label>
                                    <input id="agent_phone" readonly class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input name="invoice_number" class="form-control" readonly type="text" value="<?= @$form['invoice_number'] ?>">
                                </div>
                                <div class="col-md-12">
                                    <label>INVOICE DATE</label>
                                    <input name="invoice_date" class="form-control" readonly type="text" value="<?= @$form['invoice_date'] ?>">
                                </div>
                                <div class="col-md-12">
                                    <label>SHIPMENT TYPE</label>
                                    <input name="shipment_type" class="form-control" type="text" value="<?= @$form['shipment_type'] ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div id="order_number">
                                                    <input id="inp_order_number" name="order_number" required onclick="get_order_number()" type="text" class="form-control" autocomplete="off" placeholder="Seach Order No">
                                        ...
                                        <td>EX VESSEL</td>
                                        <td>
                                            <input readonly id="ex_vessel" type="text" class="form-control" required value="" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>CONTAINER NO</td>
                                        <td>
                                            <input id="container_no" type="text" readonly value="" class=" form-control">
                                        </td>
                                        <td>MBL NO</td>
                                        <td>
                                            <input id="mbl_no" readonly class="form-control" type="text" required value="" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>HBL NO</td>
                                        <td>
                                            <input readonly id="hbl_no" class="form-control" type="text" required value="" />
                                        </td>
                                        <td>SHIPPING</td>
                                        <td>
                                            <input readonly id="shipping" class="form-control" type="text" required value="" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>ETA</td>
                                        <td>
                                            <input readonly id="eta" class="form-control" type="text" required value="" />
                                        </td>
                                        <td>CONSIGNE</td>
                                        <td>
                                            <input readonly id="consignee" class="form-control" type="text" required value="" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                        ...
                                        <table class="table" id="tableTotal">
                                            <thead>
                                                <tr id="" style="text-align: center;">
                                                    ...
                                                    <td><input type="text" id="grand_total" name="grand_total" readonly class="form-control" value="0"></td>
...
<script>
    function get_agent() {
        var inp_id = document.getElementById('agent_name')
                ...
                success: function(isi) {
                    ...
                    if (isi.length == 0) {
                        ...
                        for (i = 0; i < isi.length; i++) {
                            if (isi[i].agent_name.substr(0, val.length).toUpperCase() == val.toUpperCase()) {

                                b = document.createElement("DIV");
                                /*make the matching letters bold:*/
                                b.setAttribute('all-data', JSON.stringify(isi[i]));
                                b.innerHTML = "<strong>" + isi[i].agent_name.substr(0, val.length) + "</strong>";
                                b.innerHTML += isi[i].agent_name.substr(val.length);
                                /*insert a input field that will hold the current array item's value:*/
                                b.innerHTML += "<input type='hidden'>";
                                /*execute a function when someone clicks on the item value (DIV element):*/
                                b.addEventListener("click", function(e) {
                                    var selected_val = JSON.parse(this.getAttribute('all-data'));
                                    var address = selected_val.agent_address + ', ' + selected_val.agent_region + ', ' + selected_val.agent_district + ', ' + selected_val.agent_city + ', ' + selected_val.agent_country + '. ' + selected_val.agent_postal_code
                                    $('#agent_id').val(selected_val.agent_id);
                                    $('#agent_name').val(selected_val.agent_name);
                                    $('#agent_address').val(address);
                                    $('#agent_phone').val(selected_val.agent_phone);
