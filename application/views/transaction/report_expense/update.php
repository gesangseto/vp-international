            ...
            <div class="card-body">
                <div class="box box-primary">
                    <div class="row">
                        <div class="col-md-6">
                            <label>Bulan</label>
                            <input name="id" class="form-control" type="hidden" required value="<?= @$form['trx_expense_id'] ?>" />
                    ...
                    <div class="col-md-12 col-sm-12">
                        <br />
                        <button type="submit" id="contact_submit" class="btn btn-info pull-right"> Simpan</button>
                    </div>
                    <!--./col-md-12-->
                </div>
            </div>
