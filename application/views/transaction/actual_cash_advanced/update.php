                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="status" id="status" class="form-control">
                                                <option <?= @$form['status'] == 'Pending' ? 'selected' : '' ?> value="Pending">Pending</option>
                                                <option <?= @$form['status'] == 'Verified' ? 'selected' : '' ?> value="Verified">Verified</option>
                                            </select>
                                        </td>
                                        <td></td>
                                        <td></td>
                            ...
                            <div class="feebox">
                                        ...
                                        <tr id="row0">
                                            ...
                                            <td width="20%">
                                                <div class="autocomplete" style="width:auto;">
                                                    ...
                                                    <input id="view0" readonly required type="text" name="task_name[]" autocomplete="off" value="<?= $row['task_name'] ?>" placeholder="Task">
                                                </div>
                                            </td>
                                            <td width="15%">
                                                <input type="text" readonly id="ca_idr_amount" name="ca_idr[]" value="<?= @$row['ca_idr'] ?>" class=" form-control inp">
                                            </td>
                                            <td width="10%">
                                                <input type="text" readonly id="ca_usd_amount" name="ca_usd[]" value="<?= @$row['ca_usd'] ?>" class=" form-control inp">
                                            </td>
                                            <td width="15%">
                                                <input type="text" id="actual_idr_amount" name="actual_idr[]" value="<?= @$row['actual_idr'] ?>" class=" form-control">
                                            </td>
                                            <td width="10%">
                                                <input type="text" id="actual_usd_amount" name="actual_usd[]" value="<?= @$row['actual_usd'] ?>" class=" form-control">
                                            </td>
                                            <td width="15%">
                                                <input type="text" id="remark" name="remark[]" value="<?= @$row['remark'] ?>" class=" form-control">
                                            </td>
                                            <td width="5%"></td>
                                        </tr>
                                ...
                                <table class="tableTotal" id="tableTotal" border="1">
                                    <tr id="" style="text-align: center;">
                                        ...
                                        <td width="15%"><input type="text" id="total_actual_idr" name="total_actual_idr" readonly class="form-control inp" value="<?= @$form['total_actual_idr'] ?>"></td>
                                        <td width="10%"><input type="text" id="total_actual_usd" name="total_actual_usd" readonly class="form-control inp" value="<?= @$form['total_actual_usd'] ?>"></td>
                                        <td width="15%"></td>
