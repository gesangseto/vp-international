                                ...
                                <table class="table3" id="tableID" border="1">
                                    ...
                                    <?php foreach ($form_detail as $row) { ?>
                                        <tr id="row0">
                                            ...
                                            <td width="15%">
                                                <input type="text" id="actual_idr_amount" name="actual_idr[]" value="<?= $row['actual_idr'] ?>" class=" form-control inp">
                                            </td>
                                            <td width="10%">
                                                <input type="text" id="actual_usd_amount" name="actual_usd[]" value="<?= $row['actual_usd'] ?>" class=" form-control inp">
                                            </td>
                                            <td width="15%">
                                                <input type="text" id="remark" name="remark[]" class=" form-control inp" value="<?= $row['remark'] ?>">
                                            </td>
                                            <td width="5%"></td>
                                        </tr>
