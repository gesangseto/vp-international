                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>TO</label>
                                    <input id="customer_id" name="customer_id" readonly type="hidden" value="<?= @$form['customer_id'] ?>">
                                    <input id="customer_name" name="customer_name" class="form-control" required onclick="get_customer()" type="text" autocomplete="off" placeholder="Seach Customer">
                                </div>
                                <div class="col-md-12">
                                    <label>Address</label>
                                    <textarea class="form-control" readonly id="customer_address"></textarea>
                                </div>
                                <div class="col-md-12">
                                    <label>PHONE</label>
                                    <input id="customer_phone" readonly class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
    ...
    function get_customer() {
        ...
        inp_id.addEventListener("input", function(e) {
            ...
            $.ajax({
                ...
                url: "<?= site_url() ?>transaction/Ajax_data/get_customer", // Isi dengan url/path file php yang dituju
                data: {
                    text: val
                },
